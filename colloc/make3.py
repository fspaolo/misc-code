...
c = '-l0.62035884781693051'    # square: l**2
...
### output file
o = '-o/dados3/fspaolo/DATA/norte/grav/models/grav_modelcs_2m_l0.62_res1.txt.err'

system('python colloc.py %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s' \
       % (E,e,G,g,S,A,B,C,D,F,H,v,c,R,I,o,s))
