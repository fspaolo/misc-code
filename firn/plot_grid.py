...
FILE2 = '/Users/fpaolo/data/shelves/all_19920716_20111015_shelf_tide_grids_mts.h5' #ris_19920715_20111015.h5' #larsenc_19920715_20111015.h5'
...
for i_1, j_1, i_2, j_2 in zip(i1, j1, i2, j2):
    ...
    m = ap.viz.plot_grid_proj(m, lons2, lats2, elev[20,...], masked=False, alpha=.2)
    m = ap.viz.plot_grid_proj(m, lons2, lats2, elev[20,...], masked=True)
    pp = m.drawparallels(np.arange(-90.,-40.,4), labels=[0,0,0,1], color='0.6')
    mm = m.drawmeridians(np.arange(-180,180.,10), labels=[0,0,1,0], color='0.6')
